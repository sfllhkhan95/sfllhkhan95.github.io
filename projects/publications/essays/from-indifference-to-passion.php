...
<head>
    ...
    <title>From Indifference to Passion (Diary) | Muhammad Saifullah Khan</title>
...
<div class="container">
    <div class="row">
        ...
        <article class="col-lg-7">
            <!-- Title -->
            <h1>From Indifference To Passion</h1>
            <h2>Why I Started Supporting Pakistan Tehreek-e-Insaf</h2>

            <!-- Author -->
            <p class="lead">
                from
                <a href="#">My Diary (2011)</a>
            </p>

            <hr>

            <!-- Preview Image -->
            <img class="img-responsive" src="/img/essays/from-indifference-to-passion.jpg" alt="">
            ...
            <div id="blog">
                ...
                <p>
                <blockquote>
                In the name of Allah, the Most Merciful, the Most Beneficent<br>
                ...
                <blockquote>
                Afraad Ke Hathon Main Hai Aqwaam Ki Taqdeer <br>
                Har Fard Hai Millat Ke Muqaddar Ka Siyyara <br>
                ...
                <blockquote>
                Tabdeeli Aa Nahi Rahi, Tabdeeli Aa Gayi Hai<br>
                [Translation: Change is not coming, it has already come]
                </blockquote>
                <p>
                and I enthusiastically agreed with him. Change had already come; in me, and in thousands of youngsters like myself, and we had woken from our apathetic stupor. I had realized that it was the time to let go of the fears, believe in myself, and make myself useful. This was the change that Imran Khan had brought about, and with the sleeping youth rising, I could see Pakistan on the doorstep of a revolution.
                </p>
            </div>

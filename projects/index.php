...
<head>
    ...
    if (uri.indexOf("?") > 0) {
      var uri = uri.substring(0, uri.indexOf("?")) + "<? echo strtolower($title); ?>";
...
<body>
    ...
    <nav id="sidebar-wrapper" class="navbar navbar-inverse">
        <div class="container container-fluid">
			...
			<ul class="nav navbar-nav navbar-right sidebar-nav">
                <li><a href="/projects/?root=apps">APPS</a></li>
                <li><a href="/projects/?root=games">GAMES</a></li>
                <li><a href="/projects/?root=web">WEBSITES</a></li>
                <li><a href="/projects/?root=libs">LIBRARIES</a></li>
                <li><a href="/projects/?root=designs">DESIGNS</a></li>
				<li><a href="/projects/?root=publications">PUBLICATIONS</a></li>
			</ul>';
				?>
        </div>
    </nav>
        ...
        <div class="gallery-grids">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2 id="title"><?echo ucwords($title);?></h2>
                    <hr class="small">
                    <div class="container">
	<?php
		if (end(explode("/", $root)) == ".") {
		...
		<div class="col-md-4 col-sm-4 gallery-top">
			<a href="/projects/?root=publications">
				<figure class="effect-bubba">
				...
				<div class='container-fluid'>
				  <div class='navbar-header'>
					<button type='button' class='modal-title title close' data-dismiss='modal'>
					  <span class='fa fa-close' style='text-shadow: 0px 0px 5px black;'></span>
					</button>
				  </div>
				</div>
			  </nav>
			  ...
			  <div class='container'>
				...
				<div class='row'>
				  ...
				  <div class='col-lg-8 my-auto'>
					<div class='container-fluid'>
					  <div class='row'>";
					  foreach ($project->features->list as $feature) { echo "
						<div class='col-lg-6'>
